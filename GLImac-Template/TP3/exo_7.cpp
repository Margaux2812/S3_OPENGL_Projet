...
int main(int argc, char** argv) {
    ...
    SDLWindowManager windowManager(800, 600, "Sphere avec Lune Camera");
    ...
    GLuint cloudTexture = texturesArray[1];
        ...
        while(windowManager.pollEvent(e)) {
            ...
            if(e.type == SDL_KEYDOWN){
                ...
                switch(e.key.keysym.sym){
                    ...
                    break;
                    /*left arrow key to move forward*/
                    case SDLK_LEFT: camera.rotateLeft(speed);
                    break;
                    /*right arrow key to move backward*/
